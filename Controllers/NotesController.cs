...
namespace MyNotesApp.Controllers
{
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,noteTitle,noteDetail")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,noteTitle,noteDetail")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
